...
<div class="page-content">
    ...
    <form class="row g-3" action="{{ route('update.room', $editData->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-md-4">
            ...
            <input type="text" name="total_adult" class="form-control" id="input2" placeholder="Last Name" value="{{ $editData->total_adult }}">
        </div>

        <div class="col-md-4">
            <label for="input3" class="form-label">Total Child</label>
            <input type="text" name="total_child" class="form-control" id="input3" placeholder="Phone" value="{{ $editData->total_child }}">
        </div>


        <div class="col-md-6">
            <label for="input4" class="form-label">Main Image</label>
            <input type="file" name="image" class="form-control" id="input4" placeholder="text">
            <img 
                id="showImage" 
                src="{{ !empty($editData->image)
                    ? url('upload/rooming/'.$editData->image)
        ...
        <div class="col-md-6">
            ...
            <input type="file" name="multi_img[]" class="form-control" id="multiImg" placeholder="Password" multiple accept="image/jpeg, image/jpg, işmage/gif, image/png">
            
            @foreach ($multiimgs as $item)
                <img 
                    src="{{ !empty($item->multi_img) 
                        ? url('upload/rooming/multi_img/'.$item->multi_img) 
                        : url('upload/no_image.jpg') }}" 
                    alt="Admin" 
                    class="bg-primary" 
                    width="60">
        ...
        <div class="col-md-3">
            ...
            <input type="text" name="size" class="form-control" id="input1" value="{{ $editData->price }}">
        </div>

        <div class="col-md-3">
            <label for="discount" class="form-label">Discount (%)</label>
            <input type="text" name="discount" class="form-control" id="discount" placeholder="Discount" value="{{ $editData->discount }}">
        </div>

        <div class="col-md-3">
            <label for="input3" class="form-label">Room Capacity</label>
            <input type="text" name="room_capacity" class="form-control" id="room_capacity" placeholder="Phone" value="{{ $editData->room_capacity }}">
        </div>
        ...
        <div class="col-md-6">
            ...
            <select name="bed_style" id="bed_style" class="form-select">
                <option selected="">Choose...</option>
                <option value="Sea View" {{ $editData->bed_style == "Sea View" ? 'selected' : '' }} >Queen Bad</option>
        ...
        <div class="col-md-12">
            ...
            <textarea name="short_desc" class="form-control" id="short_desc" placeholder="Address ..." rows="3">{{ $editData->short_desc }}</textarea>
        </div>
        ...
        <div class="col-md-12">
            ...
            <a onclick="addRoomNo()" id="addRoomNo" class="card-title btn btn-primary float-right">
                ...
                <div class="roomnoHide" id="roomnoHide">
                    <form action="{{ route('store.room.no', $editData->id) }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <label for="input3" class="form-label">Room Capacity</label>
                                <input type="text" name="room_no" class="form-control" id="room_no" placeholder="Phone">
                            </div>
                ...
                <table id="roomview" class="table mb-0 table-striped">
                    <thead>
                        <tr>
