            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div>
                        ...
                        <h4 class="my-1 text-danger">{{ $editData->code }}</h4>
          ...
          <div class="card radius-10 w-100">
              ...
              <div class="card-body">
                <div class="table-responsive">
                    <table class="table align-middl mb-0">
                    ...
                    <div style="margin-top: 40px; margin-bottom: 20px;">
                        <a href="javascript:;" class="btn btn-primary assign_room">Assign Room</a>
                    </div>
                ...
                <select name="payment_status" id="status" class="form-select">
           ...
           <div class="card radius-10 w-100">
                    ...
                    <form action="{{ route('update.booking', $editData->id) }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                ...
                                <input type="date" name="check_in" id="check_in" class="form-control" value="{{ $editData->check_in }}" required>
                            </div>
                            <div class="col-md-12 mb-2">
                                <label for="">CheckOut</label>
                                <input type="date" name="check_out" id="check_out" class="form-control" value="{{ $editData->check_out }}" required>
                            </div>
                            <div class="col-md-12 mb-2">
                                <label for="">Room</label>
                                <input type="number" name="number_of_rooms" class="form-control" value="{{ $editData->number_of_rooms }}" required>
                            </div>
            ...
            <div class="card radius-10 w-100">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <div>
                            <h6 class="mb-0">Customer Informatino</h6>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <label for="" class="my-2">Country: {{ $editData->country }}</label><br>
                    <label for="" class="my-2">State: {{ $editData->state }}</label><br>
                    <label for="" class="my-2">Zip Code: {{ $editData->zip_code }}</label><br>
                    <label for="" class="my-2">Address: {{ $editData->user->address }}</label><br>

                    <ul class="list-group list-group-flush">
                        <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center border-top">
                            Name
                            <span class="badge bg-primary rounded-pill">{{ $editData->user->name }} </span>
                        </li>
                        <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">
                            Email
                            <span class="badge bg-primary rounded-pill">{{ $editData->user->email }}</span>
                        </li>
                        <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">
                            Phone
                        ...
                        <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">
                            Country
                            <span class="badge bg-primary rounded-pill">{{ $editData->country }}</span>
                        </li>
                        <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">
                            State
                            <span class="badge bg-primary rounded-pill">{{ $editData->state }}</span>
                        </li>
                        <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">
                            Zip Code 
                            <span class="badge bg-primary rounded-pill">{{ $editData->zip_code }}</span>
                        </li>
                        <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">
                            Address 
                            <span class="badge bg-primary rounded-pill">{{ $editData->user->address }}</span>
                        </li>
                    </ul>
                </div>
            </div>
