...
<div class="room-details-area pt-100 pb-70">
    ...
    <input autocomplete="off" id="check_in" type="text" required name="check_in" class="form-control dt_picker" placeholder="yyy-mm-dd" value="{{ old('check_in') ? date('Y-m-d', strtotime(old('check_in'))) : '' }}">
            ...
            <div class="col-lg-12">
                <div class="form-group">
                    ...
                    <div class="input-group">
    <input autocomplete="off" id="check_out" type="text" required name="check_out" class="form-control dt_picker" placeholder="yyy-mm-dd" value="{{ old('check_out') ? date('Y-m-d', strtotime(old('check_out'))) : '' }}">
                        <span class="input-group-addon"></span>
                    </div>
                    <i class='bx bxs-calendar'></i>
                </div>
            ...
            <div class="col-lg-12">
                <div class="form-group">
                    ...
                    <select name="persion" id="nmbr_person" class="form-control">
                        @for ($i = 0; $i <4; $i++)
            ...
            <div class="col-lg-12">
                <div class="form-group">
                    ...
                    <select name="number_of_rooms" id="select_room" class="form-control">
                        @for ($i = 1; $i <= 5; $i++)
